<?php
class Penghantar_realisasi_table_m extends CI_Model
{
  /** Index */
  public function index($offset, $limit, $q, $order_column, $order_direction, $filters)
  {
    $this->db->select("main.logged_at, main.nama, COALESCE(main.mw, 0) AS mw, COALESCE(main.mvar, 0) AS mvar, COALESCE(main.percentage, 0) AS percentage");
