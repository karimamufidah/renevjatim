<?php
class Get_beban_trafo_monthly_plan_m extends CI_Model
{
  ...
  {
    $this->db->select("
      DAY(tanggal) AS tanggal, (ren_0030 + ren_0100 + ren_0130 + ren_0200 + ren_0230 + ren_0300 + ren_0330 + ren_0400 +
      ...
      ren_2030 + ren_2100 + ren_2130 + ren_2200 + ren_2230 + ren_2300 + ren_2330 + ren_2400) AS total
    ");

    $this->db->where('main.trafo', $params->trafo);
