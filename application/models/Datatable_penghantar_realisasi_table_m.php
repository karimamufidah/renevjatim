<?php
class Datatable_penghantar_realisasi_table_m extends CI_Model
{
    /** Index */
    public function index($offset, $limit, $q, $order_column, $order_direction, $filters)
    {
        $this->db->select("main.logged_at, COALESCE(main.mw, 0) AS mw, COALESCE(main.mx, 0) AS mx, COALESCE(main.percentage, 0) AS percentage");
    ...
    {
        $this->db->where('main.ruas', $filters->ruas);
