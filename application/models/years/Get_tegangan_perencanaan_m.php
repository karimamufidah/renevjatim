<?php
class Get_tegangan_perencanaan_m extends CI_Model
{
  ...
  public function show($filters)
  {
    if ($filters->min_max == "Max") {
      ...
      $this->db->select("
        COALESCE(MIN(ren_0030), 0) AS ren_0030, COALESCE(MIN(ren_0100), 0) AS ren_0100, COALESCE(MIN(ren_0130), 0) AS ren_0130, COALESCE(MIN(ren_0200), 0) AS ren_0200,
        COALESCE(MIN(ren_0230), 0) AS ren_0230, COALESCE(MIN(ren_0300), 0) AS ren_0300, COALESCE(MIN(ren_0330), 0) AS ren_0330, COALESCE(MIN(ren_0400), 0) AS ren_0400,
        COALESCE(MIN(ren_0430), 0) AS ren_0430, COALESCE(MIN(ren_0500), 0) AS ren_0500, COALESCE(MIN(ren_0530), 0) AS ren_0530, COALESCE(MIN(ren_0600), 0) AS ren_0600,
        COALESCE(MIN(ren_0630), 0) AS ren_0630, COALESCE(MIN(ren_0700), 0) AS ren_0700, COALESCE(MIN(ren_0730), 0) AS ren_0730, COALESCE(MIN(ren_0800), 0) AS ren_0800,
        COALESCE(MIN(ren_0830), 0) AS ren_0830, COALESCE(MIN(ren_0900), 0) AS ren_0900, COALESCE(MIN(ren_0930), 0) AS ren_0930, COALESCE(MIN(ren_1000), 0) AS ren_1000,
        COALESCE(MIN(ren_1030), 0) AS ren_1030, COALESCE(MIN(ren_1100), 0) AS ren_1100, COALESCE(MIN(ren_1130), 0) AS ren_1130, COALESCE(MIN(ren_1200), 0) AS ren_1200,
        COALESCE(MIN(ren_1230), 0) AS ren_1230, COALESCE(MIN(ren_1300), 0) AS ren_1300, COALESCE(MIN(ren_1330), 0) AS ren_1330, COALESCE(MIN(ren_1400), 0) AS ren_1400,
        COALESCE(MIN(ren_1430), 0) AS ren_1430, COALESCE(MIN(ren_1500), 0) AS ren_1500, COALESCE(MIN(ren_1530), 0) AS ren_1530, COALESCE(MIN(ren_1600), 0) AS ren_1600,
        COALESCE(MIN(ren_1630), 0) AS ren_1630, COALESCE(MIN(ren_1700), 0) AS ren_1700, COALESCE(MIN(ren_1730), 0) AS ren_1730, COALESCE(MIN(ren_1800), 0) AS ren_1800,
        COALESCE(MIN(ren_1830), 0) AS ren_1830, COALESCE(MIN(ren_1900), 0) AS ren_1900, COALESCE(MIN(ren_1930), 0) AS ren_1930, COALESCE(MIN(ren_2000), 0) AS ren_2000,
        COALESCE(MIN(ren_2030), 0) AS ren_2030, COALESCE(MIN(ren_2100), 0) AS ren_2100, COALESCE(MIN(ren_2130), 0) AS ren_2130, COALESCE(MIN(ren_2200), 0) AS ren_2200,
        COALESCE(MIN(ren_2230), 0) AS ren_2230, COALESCE(MIN(ren_2300), 0) AS ren_2300, COALESCE(MIN(ren_2330), 0) AS ren_2330, COALESCE(MIN(ren_2400), 0) AS ren_2400
      ");
    }
