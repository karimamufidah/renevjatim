...
class Xlsx_tegangan extends CI_Controller
{
  ...
  {
    $this->load->model("export/get_tegangan_perencanaan_by_date_m", "plan");
    $this->load->model("export/get_tegangan_realisasi_by_date_m", "realization");
  ...
  private function _download_spreadsheet($request)
  {
    ...
    $name = "tegangan-harian-" . str_replace(" ", "", str_replace("-", "", str_replace(":", "", generate_timezone_timestamp(null))));
