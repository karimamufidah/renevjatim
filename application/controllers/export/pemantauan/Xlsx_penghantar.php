...
class Xlsx_penghantar extends CI_Controller
{
  ...
  {
    $this->load->model("export/penghantar_for_pemantauan_m", "xlsx");
  ...
  {
    $this->load->helper('jam');
    $name = "penghantar-pemantauan-" . str_replace(" ", "", str_replace("-", "", str_replace(":", "", generate_timezone_timestamp(null))));
