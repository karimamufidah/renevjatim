...
class Xlsx_pembangkit extends CI_Controller
{
  ...
  {
    $this->load->model("years/get_pembangkit_perencanaan_m", "plan");
    $this->load->model("years/get_pembangkit_realisasi_m", "realization");
  ...
  private function _download_spreadsheet($request)
  {
    ...
    $name = "pembangkit-bulanan-" . str_replace(" ", "", str_replace("-", "", str_replace(":", "", generate_timezone_timestamp(null))));
