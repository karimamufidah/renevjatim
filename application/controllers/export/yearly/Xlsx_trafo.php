...
class Xlsx_trafo extends CI_Controller
{
  ...
  {
    $this->load->model("years/get_trafo_perencanaan_m", "plan");
    $this->load->model("years/get_trafo_realisasi_m", "realization");
  ...
  private function _download_spreadsheet($request)
  {
    ...
    $name = "trafo-bulanan-" . str_replace(" ", "", str_replace("-", "", str_replace(":", "", generate_timezone_timestamp(null))));
