...
class Interbus_transformer_perencanaan extends CI_Controller
{
  ...
  private function _validate(&$request, &$response)
  {
    ...
    if (!isset($request->inom)) $request->inom = null;
  ...
  private function _update_data($request)
  {
    ...
    $data->patch("inom", (string) $request->inom);
  ...
  private function _insert_new_data($request)
  {
    ...
    $data->ibt = $request->name;
    $data->kv = (string) $request->kv;
    $data->satuan = $request->satuan;
    $data->inom = (string) $request->inom;
