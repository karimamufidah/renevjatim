...
class Subsistem_perencanaan extends CI_Controller
{
  ...
  private function _validate(&$request, &$response)
  {
    ...
    if (!isset($request->pasokan)) $request->pasokan = "";
  ...
  private function _generate_and_insert($request, &$response)
  {
    ...
    $general_params = (object) array("tanggal" => $request->tanggal, "nama" => $request->name, "pasokan" => $request->pasokan);
  ...
  private function _update_data($request)
  {
    ...
    $data->patch("pasokan", $request->pasokan);
  ...
  private function _insert_new_data($request)
  {
    ...
    $data->subsistem = $request->name;
    $data->pasokan = $request->pasokan;
