...
class Get_beban_subsistem_perencanaan_by_date_count extends CI_Controller
{
  ...
  private function _get_data($request, &$response)
  {
    ...
    $this->load->model("utilities/get_beban_subsistem_perencanaan_by_date_count_m", "main");
