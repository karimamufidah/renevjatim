...
class Get_beban_sistem_daily extends CI_Controller
{
  ...
  {
    $this->load->model("graph/get_beban_sistem_daily_plan_m", "plan");
  ...
  {
    $this->load->model("graph/get_beban_sistem_daily_realization_m", "realization");
