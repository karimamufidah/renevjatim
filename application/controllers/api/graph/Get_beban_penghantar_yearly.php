...
class Get_beban_penghantar_yearly extends CI_Controller
{
  ...
  {
    $this->load->model("graph/get_beban_penghantar_yearly_plan_m", "plan");
  ...
  {
    $this->load->model("graph/get_beban_penghantar_yearly_realization_m", "realization");
