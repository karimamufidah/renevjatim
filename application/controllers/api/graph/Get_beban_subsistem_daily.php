...
class Get_beban_subsistem_daily extends CI_Controller
{
  ...
  {
    $this->load->model("graph/get_beban_subsistem_daily_plan_m", "plan");
  ...
  {
    $this->load->model("graph/get_beban_subsistem_daily_realization_m", "realization");
