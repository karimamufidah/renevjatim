...
class Get_beban_subsistem_monthly extends CI_Controller
{
  ...
  {
    $this->load->model("graph/get_beban_subsistem_monthly_plan_m", "plan");
  ...
  {
    $this->load->model("graph/get_beban_subsistem_monthly_realization_m", "realization");
