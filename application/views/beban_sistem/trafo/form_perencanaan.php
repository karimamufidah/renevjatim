<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <!-- Account -->
    <form id="formRegister" method="POST" action="<?= site_url('beban_sistem/process_trafo_ren') ?>">
                ...
                <div class="col-md-6">
                    <div class="card mb-4">
                        ...
                        <div class="card-body" style="height: 400px;">
                            ...
                            <div class="mb-3" <?= form_error('trafo') ? 'has-error' : null ?>>
                                <label for="trafo" class="form-label">Trafo</label>
                                <input type="text" class="form-control" id="trafo" name="trafo" placeholder="Trafo" value="<?= $row->trafo ?>" required />
                                <?= form_error('trafo') ?>
                            </div>
                            <div class="mb-3 <?= form_error('satuan') ? 'has-error' : null ?>">
                                ...
                                <select id="satuan" class="select2 form-select" name="satuan" required>
                                    ...
                                    <option value="MX" <?= set_value('satuan') == "MX" ? "selected" : null ?>>MX</option>
