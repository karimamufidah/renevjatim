<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="<?= site_url('beban_sistem/sistem_realisasi') ?>"><span class="text-muted fw-light">Beban Sistem /</span></a> Sistem | Realisasi</h4>

    <!-- Account -->
    <form id="formRegister" method="POST" action="<?= site_url('beban_sistem/process_sistem_eval') ?>">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="card mb-4">
                        ...
                        <div class="card-body" style="height: 400px;">
                            ...
                            <div class="mb-3" <?= form_error('sistem') ? 'has-error' : null ?>>
                                <label for="sistem" class="form-label">Sistem</label>
                                <input type="text" class="form-control" id="sistem" name="sistem" placeholder="Sistem" value="<?= $row->sistem ?>" required />
                                <?= form_error('sistem') ?>
                            </div>
                ...
                <div class="mt-2">
                    ...
                    <a href="<?= site_url('beban_sistem/sistem_realisasi') ?>" class="btn btn-outline-secondary">Cancel</a>
                </div>
    </form>
</div>
<!-- /Account -->