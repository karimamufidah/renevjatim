<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <form id="formBulkUpload" method="POST" onsubmit="checkDate();return false;" action="<?= site_url('beban_sistem/upload_subsistem_eval') ?>" enctype="multipart/form-data">
    <div class="card mb-4">
...
<script>
  const urlAPICountByDate = "<?= base_url("api/utilities/get-beban-subsistem-realisasi-by-date-count"); ?>";
  let crud;
