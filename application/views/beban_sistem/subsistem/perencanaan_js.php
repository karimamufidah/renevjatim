...
<script>
  const urlAPIMain = "<?= base_url("api/subsistem-perencanaan"); ?>";
  const urlAPICountByDate = "<?= base_url("api/utilities/get-beban-subsistem-perencanaan-by-date-count"); ?>";
  const urlAPIDeleteByDate = "<?= base_url("api/utilities/delete-subsistem-perencanaan-by-date"); ?>";
