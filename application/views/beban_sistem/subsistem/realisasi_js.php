...
<script>
  const urlAPIMain = "<?= base_url("api/subsistem-realisasi"); ?>";
  const urlAPICountByDate = "<?= base_url("api/utilities/get-beban-subsistem-realisasi-by-date-count"); ?>";
  const urlAPIDeleteByDate = "<?= base_url("api/utilities/delete-subsistem-realisasi-by-date"); ?>";
