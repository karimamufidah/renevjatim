<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="<?= site_url('beban_sistem/subsistem_perencanaan') ?>"><span class="text-muted fw-light">Beban Sistem /</span></a> Subsistem | Perencanaan</h4>

    <!-- Account -->
    <form id="formRegister" method="POST" action="<?= site_url('beban_sistem/process_subsistem_ren') ?>">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="card mb-4">
                        ...
                        <div class="card-body" style="height: 400px;">
                            ...
                            <div class="mb-3" <?= form_error('subsistem') ? 'has-error' : null ?>>
                                <label for="subsistem" class="form-label">Subsistem</label>
                                <input type="text" class="form-control" id="subsistem" name="subsistem" placeholder="Subsistem" value="<?= $row->subsistem ?>" required />
                                <?= form_error('subsistem') ?>
                            </div>
                            <div class="mb-3 <?= form_error('pasokan') ? 'has-error' : null ?>">
                                <label class="form-label" for="pasokan">Pasokan</label>
                                <select id="pasokan" class="select2 form-select" name="pasokan" required>
                                    <option value="<?= $row->pasokan ?>"><?= $row->pasokan ?></option>
                                    <option value="IBT" <?= set_value('pasokan') == "IBT" ? "selected" : null ?>>IBT</option>
                                    <option value="KIT" <?= set_value('pasokan') == "KIT" ? "selected" : null ?>>KIT</option>
                                    <option value="BEBAN" <?= set_value('pasokan') == "BEBAN" ? "selected" : null ?>>BEBAN</option>
                                    <option value="TRANSFER" <?= set_value('pasokan') == "TRANSFER" ? "selected" : null ?>>TRANSFER</option>
                                    <option value="DMP" <?= set_value('pasokan') == "DMP" ? "selected" : null ?>>DMP</option>
                                    <option value="%" <?= set_value('pasokan') == "%" ? "selected" : null ?>>%</option>
                                </select>
                                <?= form_error('pasokan') ?>
                            </div>
                ...
                <div class="mt-2">
                    ...
                    <a href="<?= site_url('beban_sistem/subsistem_perencanaan') ?>" class="btn btn-outline-secondary">Cancel</a>
                </div>
    </form>
</div>
<!-- /Account -->