<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4"><a href="<?= site_url('beban_sistem/subsistem_perencanaan') ?>"><span class="text-muted fw-light">Beban Sistem /</span></a> Subsistem | Realisasi</h4>

  <form id="formBulkUpload" method="POST" onsubmit="checkDate();return false;" action="<?= site_url('beban_sistem/upload_subsistem_ren') ?>" enctype="multipart/form-data">
    <div class="card mb-4">
...
<script>
  const urlAPICountByDate = "<?= base_url("api/utilities/get-beban-subsistem-perencanaan-by-date-count"); ?>";
  let crud;
