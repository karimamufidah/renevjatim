<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="<?= site_url('beban_sistem/subsistem_realisasi') ?>"><span class="text-muted fw-light">Beban Sistem /</span></a> Subsistem | Realisasi</h4>

    <!-- Account -->
    <form id="formRegister" method="POST" action="<?= site_url('beban_sistem/process_subsistem_eval') ?>">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="mt-2">
                    ...
                    <a href="<?= site_url('beban_sistem/subsistem_realisasi') ?>" class="btn btn-outline-secondary">Cancel</a>
                </div>
    </form>
</div>
<!-- /Account -->