...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="<?= site_url('beban_sistem/ibt_perencanaan') ?>"><span class="text-muted fw-light">Beban Sistem /</span></a> IBT | Perencanaan</h4>

    <!-- Account -->
    <form id="formRegister" method="POST" action="<?= site_url('beban_sistem/process_ibt_ren') ?>">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card mb-4">
                        ...
                        <div class="card-body" style="height: 480px;">
                            ...
                            <div class="mb-3" <?= form_error('ibt') ? 'has-error' : null ?>>
                                <label for="ibt" class="form-label">IBT</label>
                                <input type="text" class="form-control" id="ibt" name="ibt" placeholder="IBT" value="<?= $row->ibt ?>" required />
                                <?= form_error('ibt') ?>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="card mb-4">
                        ...
                        <div class="card-body scroll" style="overflow-y:auto; height: 435px;">
                ...
                <div class="mt-2">
                    ...
                    <a href="<?= site_url('beban_sistem/ibt_perencanaan') ?>" class="btn btn-outline-secondary">Cancel</a>
                </div>
    </form>
</div>
<!-- /Account -->