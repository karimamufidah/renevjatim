...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Beban Sistem /</span> Penghantar | Perencanaan</h4>
  ...
  <div class="row">
    <div class="col-md-12">
      <ul class="nav nav-pills flex-column flex-md-row mb-3">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?= site_url('beban_sistem/penghantar_realisasi') ?>">Realisasi</a>
        </li>
      </ul>
      <div class="card">
        <!-- Perencanaan -->
        <div class="card-header">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="<?= site_url('beban_sistem/add_penghantar_ren') ?>">Manual Input</a></li>
            <li><a class="dropdown-item" href="<?= site_url('beban_sistem/import_penghantar_ren') ?>">Import File</a></li>
          </ul>
        </div>
        <!-- Responsive Table -->
        <div class="card-body">
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                          <a class="dropdown-item" href="<?= base_url('beban_sistem/edit_penghantar_ren/' . $data->data_id); ?>"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                          <a class="dropdown-item" href="<?= base_url('beban_sistem/del_penghantar_ren/' . $data->data_id); ?>" onclick="return confirm('Apakah Anda yakin?')"><i class="bx bx-trash-alt me-1"></i> Delete</a>
                        </div>
                      </div>
                    </td>
                  </tr>
