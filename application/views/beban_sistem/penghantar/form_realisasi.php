<script type="text/javascript">
    $(function() {
        $("#satuan").change(function() {
            if ($(this).val() == "%") {
                $("#inom").prop('disabled', false);
            } else {
                $("#inom").prop('disabled', 'true');
            }
        });
    });
</script>
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="<?= site_url('beban_sistem/penghantar_realisasi') ?>"><span class="text-muted fw-light">Beban Sistem /</span></a> Penghantar | Realisasi</h4>

    <!-- Account -->
    <form id="formRegister" method="POST" action="<?= site_url('beban_sistem/process_penghantar_eval') ?>">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card mb-4">
                        ...
                        <div class="card-body" style="height: 550px;">
                            ...
                            <div class="mb-3" <?= form_error('ruas') ? 'has-error' : null ?>>
                                <label for="ruas" class="form-label">Ruas</label>
                                <input type="text" class="form-control" id="ruas" name="ruas" placeholder="Ruas" value="<?= $row->ruas ?>" required />
                                <?= form_error('ruas') ?>
                            </div>
                            <div class="mb-3" <?= form_error('kv') ? 'has-error' : null ?>>
                                <label for="kv" class="form-label">kV</label>
                                <input type="text" class="form-control" id="kv" name="kv" placeholder="kV" value="<?= $row->kv ?>" required />
                                <?= form_error('kv') ?>
                            </div>
                            <!--div class="mb-3" <?= form_error('numerik') ? 'has-error' : null ?>>
                                <label for="numerik" class="form-label">Numerik</label>
                                <input type="text" class="form-control" id="numerik" name="numerik" placeholder="Numerik" value="<?= $row->numerik ?>" required />
                                <?= form_error('numerik') ?>
                            </div-->
                            <div class="mb-3 <?= form_error('satuan') ? 'has-error' : null ?>">
                                ...
                                <select id="satuan" class="select2 form-select" name="satuan" required>
                                    ...
                                    <option value="I" <?= set_value('satuan') == "I" ? "selected" : null ?>>I</option>
                                    <option value="%" <?= set_value('satuan') == "%" ? "selected" : null ?>>%</option>
                                </select>
                                <?= form_error('satuan') ?>
                            </div>
                            <div class="mb-3" <?= form_error('inom') ? 'has-error' : null ?>>
                                <label for="inom" class="form-label">INOM</label>
                                <input type="text" class="form-control" id="inom" name="inom" placeholder="INOM" value="<?= $row->inom ?>" disabled />
                                <?= form_error('inom') ?>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="card mb-4">
                        ...
                        <div class="card-body scroll" style="overflow-y:auto; height: 502px;">
                ...
                <div class="mt-2">
                    ...
                    <a href="<?= site_url('beban_sistem/penghantar_realisasi') ?>" class="btn btn-outline-secondary">Cancel</a>
                </div>
    </form>
</div>
<!-- /Account -->