<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Deklarasi TMP </span>
        <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#modalCenter">Upload File</button>
    </h4>

    <!-- Modal -->
    <form id="formRegister" method="POST" action="<?= base_url('laporan/uploadDeklarasi'); ?>" enctype="multipart/form-data">
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="text-nowrap float-end">
                                    ...
                                    <a class="btn btn-primary btn-xs" href="<?= site_url('laporan/downloadDeklarasi/' . $data->file_id) ?>"><i class='bx bxs-download'></i> Download</a>
                                    <a class="btn btn-danger btn-xs" href="<?= site_url('laporan/deleteDeklarasi/' . $data->file_id) ?>" onclick="return confirm('Apakah Anda yakin?')"><i class='bx bxs-trash'></i> Delete</a>
