<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="<?= site_url('tegangan/perencanaan') ?>"><span class="text-muted fw-light">Tegangan /</span></a> Perencanaan</h4>

    <!-- Account -->
    <form id="formRegister" method="POST" action="<?= site_url('tegangan/process') ?>">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="mt-2">
                    ...
                    <a href="<?= site_url('tegangan/perencanaan') ?>" class="btn btn-outline-secondary">Cancel</a>
                </div>
    </form>
</div>
<!-- /Account -->