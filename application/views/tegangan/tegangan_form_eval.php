<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="<?= site_url('tegangan/realisasi') ?>"><span class="text-muted fw-light">Tegangan /</span></a> Perencanaan</h4>

    <!-- Account -->
    <form id="formRegister" method="POST" action="<?= site_url('tegangan/process_eval') ?>">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="card mb-4">
                        ...
                        <div class="card-body" style="height: 400px;">
                            ...
                            <div class="mb-3" <?= form_error('gardu_induk') ? 'has-error' : null ?>>
                                <label for="gardu_induk" class="form-label">Gardu Induk</label>
                                <input type="text" class="form-control" id="gardu_induk" name="gardu_induk" placeholder="Gardu Induk" value="<?= $row->gardu_induk ?>" required />
                                <?= form_error('gardu_induk') ?>
                            </div>
                            <div class="mb-3" <?= form_error('busbar') ? 'has-error' : null ?>>
                                <label for="busbar" class="form-label">Busbar</label>
                                <input type="text" class="form-control" id="busbar" name="busbar" placeholder="Busbar" value="<?= $row->busbar ?>" />
                                <?= form_error('busbar') ?>
                            </div>
                            <div class="mb-3">
                                <label for="kV" class="form-label">kV</label>
                                <input type="text" class="form-control" id="kv" name="kv" placeholder="kV" value="<?= $row->kv ?>" />
                                <?= form_error('kv') ?>
                            </div>
                ...
                <div class="mt-2">
                    ...
                    <a href="<?= site_url('tegangan/realisasi') ?>" class="btn btn-outline-secondary">Cancel</a>
                </div>
    </form>
</div>
<!-- /Account -->