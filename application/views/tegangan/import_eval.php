<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4"><a href="<?= site_url('tegangan/realisasi') ?>"><span class="text-muted fw-light">Tegangan /</span></a> Realisasi</h4>

  <form id="formBulkUpload" method="POST" onsubmit="checkDate();return false;" action="<?= site_url('tegangan/upload_eval') ?>" enctype="multipart/form-data">
    <div class="card mb-4">
