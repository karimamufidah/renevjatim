      ...
      <div class="card-body">
        <div class="row">
          <div class="col-4">
            ...
            <div class="row mt-3">
              <div class="col-6">
                <button class="btn btn-default col-12" onclick="downloadTrafoDailyXLSX()"><i class="bx bx-download"></i>&nbsp; Download</button>
              </div>
              <div class="col-6">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-4">
            ...
            <div class="row mt-3">
              <div class="col-6">
                <button class="btn btn-default col-12" onclick="downloadTrafoMonthlyXLSX()"><i class="bx bx-download"></i>&nbsp; Download</button>
              </div>
              <div class="col-6">
          ...
          <div class="col-4">
            ...
            <div class="row mt-3">
              <div class="col-12">
                ...
                <button class="btn btn-default col-12 mt-1" onclick="downloadTrafoPemantauanXLSX()"><i class="bx bx-download"></i>&nbsp; Download</button>
              </div>
            </div>
          </div>
