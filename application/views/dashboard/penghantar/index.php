<div class="tab-pane fade show active" id="navs-pills-top-pht" role="tabpanel">
  <div class="row">
    <div class="col-12 mb-4">
      <select id="penghantar-panel" class="select2-penghantar form-control" style="width: 100%;" onchange="getAndFillPenghantarPanelData()">
        <option id="penghantar-panel-default" selected></option>
      </select>
    </div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="h5 mb-0 font-weight-bold text-gray-800" id="penghantar-highest-this-month">0</div>
              <small class="text-muted"><em id="penghantar-highest-this-month-datetime">Sedang memuat...</em></small>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="h5 mb-0 font-weight-bold text-gray-800" id="penghantar-highest-this-year">0</div>
              <small class="text-muted"><em id="penghantar-highest-this-year-datetime">Sedang memuat...</em></small>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="h5 mb-0 font-weight-bold text-gray-800" id="penghantar-highest-all-time">0</div>
              <small class="text-muted"><em id="penghantar-highest-all-time-datetime">Sedang memuat...</em></small>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-4">
            ...
            <div class="row mt-3">
              <div class="col-6">
                <button class="btn btn-default col-12" onclick="downloadPenghantarDailyXLSX()"><i class="bx bx-download"></i>&nbsp; Download</button>
              </div>
              <div class="col-6">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-4">
            ...
            <div class="row mt-3">
              <div class="col-6">
                <button class="btn btn-default col-12" onclick="downloadPenghantarMonthlyXLSX()"><i class="bx bx-download"></i>&nbsp; Download</button>
              </div>
              <div class="col-6">
