<div class="tab-pane fade" id="navs-pills-top-ibt" role="tabpanel">
  <div class="row">
    <div class="col-12 mb-4">
      <select id="ibt-panel" class="select2-ibt form-control" style="width: 100%;" onchange="getAndFillIBTPanelData()">
        <option id="ibt-panel-default" selected></option>
      </select>
    </div>
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-4">
            ...
            <div class="row mt-3">
              <div class="col-6">
                <button class="btn btn-default col-12" onclick="downloadIBTYearlyXLSX()"><i class="bx bx-download"></i>&nbsp; Download</button>
              </div>
              <div class="col-6">
