<div class="tab-pane fade" id="navs-pills-top-subsistem" role="tabpanel">
  <div class="row">
    <div class="col-12 mb-4">
      <select id="subsistem-panel" class="select2-subsistem form-control" style="width: 100%;" onchange="getAndFillSubsistemPanelData()">
        <option id="subsistem-panel-default" selected></option>
      </select>
    </div>
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-4">
            ...
            <div class="row mt-3">
              <div class="col-6">
                <button class="btn btn-default col-12" onclick="downloadSubsistemDailyXLSX()"><i class="bx bx-download"></i>&nbsp; Download</button>
              </div>
              <div class="col-6">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-4">
            ...
            <div class="row mt-3">
              <div class="col-6">
                <button class="btn btn-default col-12" onclick="downloadSubsistemMonthlyXLSX()"><i class="bx bx-download"></i>&nbsp; Download</button>
              </div>
              <div class="col-6">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-4">
            ...
            <div class="row mt-3">
              <div class="col-6">
                <button class="btn btn-default col-12" onclick="downloadSubsistemYearlyXLSX()"><i class="bx bx-download"></i>&nbsp; Download</button>
              </div>
              <div class="col-6">
