<div class="tab-pane fade" id="navs-pills-top-teg" role="tabpanel">
  <div class="row">
    <div class="col-12 mb-4">
      <select id="tegangan-panel" class="select2-tegangan form-control" style="width: 100%;" onchange="getAndFillTeganganPanelData()">
        <option id="tegangan-panel-default" selected></option>
      </select>
    </div>
              ...
              <table id="tegangan-datatable" class="table table-borderless table-striped" style="width:100%">
                <thead>
                  <tr>
                    ...
                    <th style="text-align:right">kV</th>
                  </tr>
                </thead>
              </table>
            </div>
